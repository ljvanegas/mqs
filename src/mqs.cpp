...
//main function
// [[Rcpp::export]]
List mqs(NumericVector Y, double beta = 0.5, Rcpp::Nullable<double> q = R_NilValue, double alpha = 0.05, std::string type = "runs" ){
  ...
  List ans = List::create(Named("value") = value, Named("left") = left, Named("n") = n);
  ans.attr("class") = "mqs";
